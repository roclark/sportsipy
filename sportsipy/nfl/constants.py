...
PLAYER_SCHEME = {
    ...
    'defensive_times_targeted': 'td[data-stat="def_targets"]',
    'completions_allowed': 'td[data-stat="def_cmp"]',
    'completion_percentage_allowed': 'td[data-stat="def_cmp_perc"]',
    'completion_yards_allowed': 'td[data-stat="def_cmp_yds"]',
    'defensive_yards_per_completion': 'td[data-stat="def_yds_per_cmp"]',
    'defensive_yards_per_target': 'td[data-stat="def_yds_per_tgt"]',
    'touchdowns_allowed': 'td[data-stat="def_cmp_td"]',
    'passer_rating_allowed': 'td[data-stat="def_pass_rating"]',
    'defensive_depth_of_throw': 'td[data-stat="def_tgt_yds_per_att"]',
    'air_yards_allowed': 'td[data-stat="def_air_yds"]',
    'yards_after_catch_allowed': 'td[data-stat="def_yac"]',
