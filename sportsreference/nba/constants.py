...
BOXSCORE_SCHEME = {
    ...
    'away_minutes_played': 'td[data-stat="mp"]:last',
    'away_field_goals': 'td[data-stat="fg"]:last',
    'away_field_goal_attempts': 'td[data-stat="fga"]:last',
    'away_field_goal_percentage': 'td[data-stat="fg_pct"]:last',
    'away_two_point_field_goals': 'td[data-stat="fg2"]:last',
    'away_two_point_field_goal_attempts': 'td[data-stat="fg2a"]:last',
    'away_two_point_field_goal_percentage': 'td[data-stat="fg2_pct"]:last',
    'away_three_point_field_goals': 'td[data-stat="fg3"]:last',
    'away_three_point_field_goal_attempts': 'td[data-stat="fg3a"]:last',
    'away_three_point_field_goal_percentage': 'td[data-stat="fg3_pct"]:last',
    'away_free_throws': 'td[data-stat="ft"]:last',
    'away_free_throw_attempts': 'td[data-stat="fta"]:last',
    'away_free_throw_percentage': 'td[data-stat="ft_pct"]:last',
    'away_offensive_rebounds': 'td[data-stat="orb"]:last',
    'away_defensive_rebounds': 'td[data-stat="drb"]:last',
    'away_total_rebounds': 'td[data-stat="trb"]:last',
    'away_assists': 'td[data-stat="ast"]:last',
    'away_steals': 'td[data-stat="stl"]:last',
    'away_blocks': 'td[data-stat="blk"]:last',
    'away_turnovers': 'td[data-stat="tov"]:last',
    'away_personal_fouls': 'td[data-stat="pf"]:last',
    'away_points': 'td[data-stat="pts"]:last',
    'away_true_shooting_percentage': 'td[data-stat="ts_pct"]:last',
    'away_effective_field_goal_percentage': 'td[data-stat="efg_pct"]:last',
    'away_three_point_attempt_rate': 'td[data-stat="fg3a_per_fga_pct"]:last',
    'away_free_throw_attempt_rate': 'td[data-stat="fta_per_fga_pct"]:last',
    'away_offensive_rebound_percentage': 'td[data-stat="orb_pct"]:last',
    'away_defensive_rebound_percentage': 'td[data-stat="drb_pct"]:last',
    'away_total_rebound_percentage': 'td[data-stat="trb_pct"]:last',
    'away_assist_percentage': 'td[data-stat="ast_pct"]:last',
    'away_steal_percentage': 'td[data-stat="stl_pct"]:last',
    'away_block_percentage': 'td[data-stat="blk_pct"]:last',
    'away_turnover_percentage': 'td[data-stat="tov_pct"]:last',
    'away_offensive_rating': 'td[data-stat="off_rtg"]:last',
    'away_defensive_rating': 'td[data-stat="def_rtg"]:last',
