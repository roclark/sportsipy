...
PLAYER_SCHEME = {
    ...
    'longest_kickoff_return': 'td[data-stat="kick_ret_td"]',
    ...
    'longest_interception_return': 'td[data-stat="df_int_long"]',
    'passes_defended': 'td[data-stat="pass_defended"]',
    'fumbles_forced': 'td[data-stat="fumbles_forced"]',
    'fumbles_recovered': 'td[data-stat="fumbles"]',
    'yards_recovered_from_fumble': 'td[data-stat="fumbles_rec"]',
