...
class Team:
    ...
    def simple_rating_system(self):
        """
        Returns a float of the team's average point differential compared to
        the strength of schedule. Higher values indicate stronger teams. An
    ...
    def strength_of_schedule(self):
        """
        Returns a float of the team's strength of schedule based on the points
        above and below average. An average strength of schedule is denoted
        with 0.0. Negative numbers are comparatively easier than average.
        """
    ...
    def home_wins(self):
        """
        Returns an int of the total number of home games the team won during
        the season.
        """
    ...
    def home_losses(self):
        """
        Returns an int of the total number of home games the team lost during
        the season.
        """
    ...
    def away_wins(self):
        """
        Returns an int of the total number of away games the team won during
        the season.
        """
    ...
    def away_losses(self):
        """
        Returns an int of the total number of away games the team lost during
        the season.
        """
    ...
    def points(self):
        """
        Returns an int of the total number of points the team scored during the
        season.
        """
    ...
    def minutes_played(self):
        """
        Returns an int of the total number of minutes played by the team during
        the season.
        """
    ...
    def field_goal_attempts(self):
        """
        Returns an int of the total number of field goal attempts during the
        season.
        """
    ...
    def field_goal_percentage(self):
        ...
        number of field goal attempts. Percentage ranges from 0-1.
        """
    ...
    def three_point_field_goal_percentage(self):
        ...
        by the number of three point field goal attempts. Percentage ranges
        from 0-1.
        """
    ...
    def free_throw_percentage(self):
        ...
        of free throw attempts during the season.
        """
    ...
    def opp_field_goal_percentage(self):
        """
        Returns a float of the number of field goals made divided by the total
        number of field goal attempts by opponents. Percentage ranges from 0-1.
        """
    ...
    def opp_three_point_field_goal_percentage(self):
        """
        Returns a float of the number of three point field goals made divided
        by the number of three point field goal attempts by opponents.
    ...
    def opp_free_throw_percentage(self):
        """
        Returns a float of the number of free throws made divided by the number
        of free throw attempts during the season by opponents.
        """
    ...
    def opp_turnovers(self):
        """
        Returns an int of the total number of turnovers during the season by
        opponents.
        """
    ...
    def three_point_attempt_rate(self):
        ...
        range. Percentage ranges from 0-1.
        """
    ...
    def true_shooting_percentage(self):
        """
        Returns a float of the team's true shooting percentage which considers
        free throws, 2-point field goals, and 3-point field goals. Percentage
        ranges from 0-1.
        """
    ...
    def total_rebound_percentage(self):
        """
        Returns a float of the percentage of available rebounds a team grabbed.
    ...
    def assist_percentage(self):
        """
        Returns a float of the percentage of field goals that were assisted.
        Percentage ranges from 0-100.
        """
    ...
    def steal_percentage(self):
        """
        Returns a float of the percentage of opponent possessions that ended
        in a steal. Percentage ranges from 0-100.
        """
    ...
    def effective_field_goal_percentage(self):
        """
        Returns a float of the field goal percentage while giving extra weight
        to 3-point field goals. Percentage ranges from 0-1.
        """
    ...
    def turnover_percentage(self):
        """
        Returns a float of the number of times the team turned the ball over
        per 100 possessions.
        """
    ...
    def opp_three_point_attempt_rate(self):
        """
        Returns a float of the percentage of field goal attempts from 3-point
        range by the opponent. Percentage ranges from 0-1.
        """
    ...
    def opp_total_rebound_percentage(self):
        """
        Returns a float of the percentage of available rebounds the opponent
    ...
    def opp_assist_percentage(self):
        """
        Returns a float of the percentage of the opponent's field goals that
    ...
    def opp_steal_percentage(self):
        ...
        by the opponent. Percentage ranges from 0-100.
        """
    ...
    def opp_effective_field_goal_percentage(self):
        """
        Returns a float of the opponent's field goal percentage while giving
    ...
    def opp_free_throws_per_field_goal_attempt(self):
        """
        Returns a float of the number of free throws per field goal attempt by
        the opponent.
        """
