...
class TestNBABoxscore:
    ...
    def setup_method(self, *args, **kwargs):
        self.results = {
            ...
            "away_points": 93,
            "away_true_shooting_percentage": 0.488,
            "away_effective_field_goal_percentage": 0.489,
            "away_three_point_attempt_rate": 0.351,
            "away_free_throw_attempt_rate": 0.032,
            ...
            "home_points": 113,
            "home_true_shooting_percentage": 0.582,
            "home_effective_field_goal_percentage": 0.560,
            "home_three_point_attempt_rate": 0.286,
            "home_free_throw_attempt_rate": 0.154,
    ...
    def test_nba_boxscore_string_representation(self):
        expected = (
            "Boxscore for Detroit Pistons at Los Angeles Lakers "
